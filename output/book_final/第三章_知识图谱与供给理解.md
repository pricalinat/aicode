...
知识图谱是一种用于描述现实世界中实体及其之间关系的结构化知识库。知识图谱的核心思想是将知识表示为"实体-关系-实体"的三元组形式。
### 3.3.1 知识图谱的定义与组成
...
知识图谱的构建通常包括知识抽取、知识融合和知识推理三个主要阶段。
知识图谱的构建通常包括以下几个主要阶段：
...
近年来，知识图谱嵌入领域出现了多个重要进展，包括RotatE、QuatE、KEPLER、CoKE等模型。
